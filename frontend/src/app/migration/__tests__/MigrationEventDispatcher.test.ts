...
describe('MigrationEventDispatcher Tests', () => {
  ...
  test('should set version after event invoked', () => {
    const event0 = new MigrationEvent<MigrationFixture>(APP_VERSION_INIT, m => m);
    const dispatcher = new MigrationEventDispatcher(event0);
  ...
  test('should process events one by one and set last version', () => {
    const event0 = new MigrationEvent<MigrationFixture>(APP_VERSION_INIT, m => m);
    const event1 = new MigrationEvent<MigrationFixture>(APP_VERSION_BETA_0, m => m);
  ...
  test('should process events with no init version', () => {
    const event2 = new MigrationEvent<MigrationFixture>(APP_VERSION_BETA_2, m => m);
  ...
  test('should return initialize model value if exception happen', () => {
    ...
    const event1 = new MigrationEvent<MigrationFixture>(APP_VERSION_BETA_1, m => {
  ...
  test('should migrate change by some events', () => {
    ...
    expect(dispatcher.process(createFixture({ version: undefined, id: 0 }))).toMatchObject({
      beta: 3,
  ...
  test('should migrate change by all merge events', () => {
    const eventInit = new MigrationEvent<MigrationFixture>(APP_VERSION_INIT, m => {
      const fixture = expectFixture(m);
      fixture.id = 1;
      return fixture;
    });
    const event0 = new MigrationEvent<MigrationFixture>(APP_VERSION_BETA_0, m => {
      const fixture = expectFixture(m);
      fixture.beta = 2;
      return fixture;
    });
    ...
    const event2 = new MigrationEvent<MigrationFixture>(APP_VERSION_BETA_2, m => {
      const fixture = expectFixture(m);
      fixture.beta2 = 3;
      return fixture;
    });
  ...
  test('should migrate change with specific version', () => {
    ...
    expect(
      dispatcher.process(createFixture({
        id: 0,
        beta: 2,
        version: APP_VERSION_BETA_1,
      })),
