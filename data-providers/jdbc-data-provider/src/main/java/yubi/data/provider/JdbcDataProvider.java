...
import yubi.data.provider.calcite.SqlParserUtils;
import yubi.data.provider.calcite.dialect.SqlStdOperatorSupport;
import yubi.data.provider.jdbc.DataSourceFactory;
import yubi.data.provider.jdbc.DataSourceFactoryHikariImpl;
...
public class JdbcDataProvider extends DataProvider {
    ...
    public static final String DEFAULT_ADAPTER = "yubi.data.provider.jdbc.adapters.JdbcDataProviderAdapter";
    ...
    public static DataSourceFactory<? extends DataSource> getDataSourceFactory() {
        return new DataSourceFactoryHikariImpl();
    }
