...
import yubi.data.provider.jdbc.DataTypeUtils;
import yubi.data.provider.jdbc.ResultSetMapper;
...
public class LocalDB {
    ...
    private static void createFunctionTableIfNotExists(Connection connection) {
        try {
            Statement statement = connection.createStatement();
            statement.execute("CREATE ALIAS FUNCTION_TABLE  FOR \"yubi.data.provider.local.LocalDB.dataframeTable\"");
