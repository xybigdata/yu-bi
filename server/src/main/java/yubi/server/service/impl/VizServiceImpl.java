...
import yubi.core.base.consts.TransferFileType;
...
import yubi.server.base.transfer.*;
import yubi.server.base.transfer.model.*;
...
public class VizServiceImpl extends BaseService implements VizService {
    ...
    public DownloadTaskDTO exportResource(ResourceTransferParam param) throws IOException {
        ...
        }, param, TransferFileType.YUBI_RESOURCE_FILE);
    }
    ...
    public DownloadTaskDTO exportDatachartTemplate(DatachartTemplateParam param) {
        ...
        }, param, TransferFileType.YUBI_TEMPLATE_FILE);
    }
