...
@Component
public class ShiroAuthenticationTokenAdapter implements AuthenticationTokenAdapter<AuthenticationToken> {
    ...
    @Override
    public boolean matches(AuthenticationToken token, String credentials) {
