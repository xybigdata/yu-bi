...
public class WebUtils {
    ...
    private static WebDriver createWebDriver() throws Exception {
        ...
        String driverPath = Application.getProperty("yubi.screenshot.webdriver-path");

        if (StringUtils.isEmpty(driverPath)) {
            Exceptions.msg("message.not.found.webdriver");
        }

        String driverType = Application.getProperty("yubi.screenshot.webdriver-type");
    ...
    public static Integer getTimeout() {
        return Integer.parseInt(Application.getProperty("yubi.screenshot.timeout-seconds", DEFAULT_TIMEOUT.toString()));
    }
